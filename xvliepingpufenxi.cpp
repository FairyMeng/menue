...
#include "ui_xvliepingpufenxi.h"


xvliepingpufenxi::xvliepingpufenxi(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::xvliepingpufenxi)
{
    ui->setupUi(this);
    setupPlot();
...
xvliepingpufenxi::~xvliepingpufenxi()
{
    delete ui;
}
void xvliepingpufenxi::setupPlot()
{
...
void xvliepingpufenxi::horzScrollBarChanged(int value)
{
...
void xvliepingpufenxi::vertScrollBarChanged(int value)
{
...
//void xvliepingpufenxi::xAxisChanged(QCPRange range)
//{
//  ui->horizontalScrollBar->setValue(qRound(range.center()*100.0)); // adjust position of scroll bar slider
//  ui->horizontalScrollBar->setPageStep(qRound(range.size()*100.0)); // adjust size of scroll bar slider
//}

//void xvliepingpufenxi::yAxisChanged(QCPRange range)
//{
